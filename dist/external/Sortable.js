    ...
    execute: function () {
      ...
      !function (t, e) {
        ...
        var x = [],
          ...
          initializePlugins: function initializePlugins(o, i, r, t) {
        ...
        var z,
            ...
            xt = St && !i && !n && "draggable" in document.createElement("div"),
            Mt = function () {
          if (St) {
            if (w) return !1;
        ...
        Rt.prototype = {
          ...
          _prepareDragStart: function _prepareDragStart(t, e, n) {
            ...
            if (n && !z && n.parentNode === r) {
              ...
              if (q = r, G = (z = n).parentNode, V = z.nextSibling, Z = n, ot = a.group, rt = {
                ...
                clientX: (e || t).clientX,
                clientY: (e || t).clientY
              }, ct = rt.clientX - s.left, ut = rt.clientY - s.top, this._lastX = (e || t).clientX, this._lastY = (e || t).clientY, z.style["will-change"] = "all", o = function o() {
                K("delayEnded", i, {
                  evt: t
                ...
                g(z, t.trim(), Yt);
              }), u(l, "dragover", Pt), u(l, "mousemove", Pt), u(l, "touchmove", Pt), u(l, "mouseup", i._onDrop), u(l, "touchend", i._onDrop), u(l, "touchcancel", i._onDrop), c && this.nativeDraggable && (this.options.touchStartThreshold = 4, z.draggable = !0), K("delayStart", this, {
                evt: t
              }), !a.delay || a.delayOnTouchOnly && !e || this.nativeDraggable && (E || w)) o();else {
          ...
          _onDragStart: function _onDragStart(t, e) {
            ...
            K("dragStart", this, {
              evt: t
            }), Rt.eventCanceled ? this._onDrop() : (K("setupClone", this), Rt.eventCanceled || ((Q = _(z)).draggable = !1, Q.style["will-change"] = "", this._hideClone(), k(Q, this.options.chosenClass, !1), Rt.clone = Q), n.cloneId = Ht(function () {
              ...
              if (mt = !1, c && !e.disabled && (u ? d || (r = !q.contains(z)) : it === this || (this.lastPutMode = ot.checkPull(this, c, z, n)) && t.checkPut(this, c, z, n))) {
                ...
                if (!g || function (t, e, n) {
                  ...
                  if (ht !== s && (m = i[E], yt = !1, wt = !w && e.invertSwap || y), 0 !== (v = function (t, e, n, o, i, r, a, l) {
                    ...
                    return 0;
                  }(n, s, i, a, w ? 1 : e.swapThreshold, null == e.invertedSwapThreshold ? e.swapThreshold : e.invertedSwapThreshold, wt, ht === s))) for (var S = F(z); S -= v, (b = G.children[S]) && ("none" === R(b, "display") || b === U);) {
                    ;
                  }
                  ...
                  if (!1 !== x) return 1 !== x && -1 !== x || (T = 1 === x), Dt = !0, setTimeout(Bt, 30), O(), T && !C ? l.appendChild(z) : s.parentNode.insertBefore(z, T ? C : s), D && L(D, 0, _ - D.scrollTop), G = z.parentNode, void 0 === m || wt || (pt = Math.abs(m - X(s)[E])), N(), A(!0);
                }
          ...
          _nulling: function _nulling() {
            K("nulling", this), q = z = G = U = V = Q = Z = $ = rt = at = dt = tt = nt = J = et = ht = ft = it = ot = Rt.dragged = Rt.ghost = Rt.clone = Rt.active = null, _t.forEach(function (t) {
              t.checked = !0;
            }), _t.length = lt = st = 0;
          },
          ...
          destroy: function destroy() {
            ...
            }), this._onDrop(), bt.splice(bt.indexOf(this.el), 1), this.el = t = null;
          },
        ...
        }, St && u(document, "touchmove", function (t) {
          ...
          if (t.scroll) {
            ...
            do {
              var f = h,
                  ...
                  T = f.scrollLeft,
                  x = f.scrollTop;
              D = f === c ? (E = y < _ && ("auto" === C.overflowX || "scroll" === C.overflowX || "visible" === C.overflowX), w < S && ("auto" === C.overflowY || "scroll" === C.overflowY || "visible" === C.overflowY)) : (E = y < _ && ("auto" === C.overflowX || "scroll" === C.overflowX), w < S && ("auto" === C.overflowY || "scroll" === C.overflowY));
              var M = E && (Math.abs(b - r) <= l && T + y < _) - (Math.abs(m - r) <= l && !!T),
                  O = D && (Math.abs(v - a) <= l && x + w < S) - (Math.abs(g - a) <= l && !!x);
              if (!qt[d]) for (var A = 0; A <= d; A++) {
                qt[A] || (qt[A] = {});
              }
        ...
        return Rt.mount(new function () {
          ...
          return t.prototype = {
            ...
            setupClone: function setupClone(t) {
              ...
              if (this.isMultiDrag) {
                for (var o = 0; o < se.length; o++) {
                  ce.push(_(se[o])), ce[o].sortableIndex = se[o].sortableIndex, ce[o].draggable = !1, ce[o].style["will-change"] = "", k(ce[o], this.options.selectedClass, !1), se[o] === re && k(ce[o], this.options.chosenClass, !1);
                }
                ...
                if (!he) if (c.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(), k(re, c.selectedClass, !~se.indexOf(re)), ~se.indexOf(re)) se.splice(se.indexOf(re), 1), oe = null, A({
                  ...
                  if (se.push(re), A({
                    ...
                    if (~f && ~p && f !== p) for (d = f < p ? (h = f, p) : (h = p, f + 1); h < d; h++) {
                      ~se.indexOf(u[h]) || (k(u[h], c.selectedClass, !0), se.push(u[h]), A({
                        sortable: i,
                        rootEl: n,
                        name: "select",
                        targetEl: u[h],
            ...
            _deselectMultiDrag: function _deselectMultiDrag(t) {
              if (!he && ie === this.sortable && !(t && P(t.target, this.options.draggable, this.sortable.el, !1) || t && 0 !== t.button)) for (; se.length;) {
                var e = se[0];
