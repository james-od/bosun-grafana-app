...
System.register(["app/core/table_model", "moment"], function (_export, _context) {
  ...
  var TableModel, moment, BosunDatasource;
      ...
      _export("BosunDatasource", BosunDatasource = function () {
        ...
        _createClass(BosunDatasource, [{
          ...
          value: function metricFindQuery(query) {
            ...
            var metricsRegex = /metrics\((.*)\)/; // Get tag keys for the given metric (first argument)

            var tagKeysRegex = /tagkeys\((.*)\)/; // Get tag values for the given metric (first argument) and tag key (second argument)
          ...
          value: function query(options) {
            var queries = []; // Get time values to replace $start
