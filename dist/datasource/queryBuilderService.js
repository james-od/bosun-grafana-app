...
System.register([], function (_export, _context) {
  ...
  function substituteFinalQuery(finalQuery, controller) {
      ...
      if (value.type === "variable") {
        if (variableIsValid(value)) {
          if (value["inputValue"] === undefined) {
            substitutedFinalQuery = substituteVariable(substitutedFinalQuery, value["inputName"], "");
          } else {
            substitutedFinalQuery = substituteVariable(substitutedFinalQuery, value["inputName"], value["inputValue"]);
          }
        }
      }

      if (value.type === "queryVariable") {
        substitutedFinalQuery = substituteVariable(substitutedFinalQuery, value["inputValue"], buildQueryVariable(orderedVariablesList, value, index, controller));
      }
  ...
  _export("substituteFinalQuery", substituteFinalQuery);
